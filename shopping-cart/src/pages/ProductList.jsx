...
import { addItem } from "../store/cartSlice"; // ✅ Import Redux action
...
function ProductList() {
  ...
  const handleAddToCart = (product) => {
    dispatch(
      addItem({
        id: product._id, // ✅ Ensure ID is set correctly
        title: product.title,
        price: product.price,
        image: `http://localhost:5000/uploads/${product.image}`, // ✅ Use backend image path
      })
    );
  };
